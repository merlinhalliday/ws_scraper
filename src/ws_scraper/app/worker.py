...
from ws_scraper.common.helpers import coerce_float, coerce_int, parse_coinbase_heartbeat_time, parse_iso8601
...
def build_retrying_session() -> requests.Session:
    ...
    session.headers.update({"User-Agent": "ws-scraper-snapshot/1.0"})
    retry = Retry(
        total=2,
        connect=2,
        read=2,
